...
<div>
<strong>$assoc_args</strong> (array&lt;string|int,string|bool&gt;) Arguments array.<br />
<strong>$flag</strong> (string|int) Flag to get the value.<br />
<strong>$default</strong> (string|bool|int|null) Default value for the flag. Default: NULL.<br />
<strong>@return</strong> (string|bool|int|null) <br />
</div>
