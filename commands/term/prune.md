...
Useful for cleaning up large sites with many unused or barely-used terms. The term count is based on the number of published posts assigned to each term.
