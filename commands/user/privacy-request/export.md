...
Runs all registered data exporters for the email address associated with the request, generates a ZIP file containing the data, then marks the request as completed.
